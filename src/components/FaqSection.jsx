...
const FAQ = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center mx-4 md:mx-12'>
      <h2 className='text-3xl font-bold text-center mb-8 justify-center'>
        FAQs
      </h2>
      <div className=' grid grid-cols-1  md:grid-cols-2 gap-4 justify-center max-w-[700px]  items-center mx-auto w-full'>
        {faqs.map((faq, index) => (
          <FAQItem
            key={index}
